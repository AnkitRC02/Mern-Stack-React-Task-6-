...
Let's embark on this exciting journey of exploration, learning, and transformation together.</p>
      ...
      <div className="project">
        ...
        <p>This is a project if a code that is designed to make gaming more interesting. 
           ...
           <img src={require('D:\\Importants\\Ethanus mern stack internship program course\\React\\portfolio\\src\\Images\\maxresdefault.jpg')} alt="Project 1" style={{ maxWidth: '300px', height: 'auto' }} />
      </div>
      <div className="project">
        <h3>Project 2</h3>
        ...
        <img src={require('D:\\Importants\\Ethanus mern stack internship program course\\React\\portfolio\\src\\Images\\download.png')} alt="Project 2" style={{ maxWidth: '500px', height: 'auto' }} />
      ...
      <div className="project">
        ...
        <img src={require('D:\\Importants\\Ethanus mern stack internship program course\\React\\portfolio\\src\\Images\\origin.jpg')} alt="Project 3" style={{ maxWidth: '300px', height: 'auto' }} />
